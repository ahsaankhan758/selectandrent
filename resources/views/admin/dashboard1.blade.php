            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row">
                        <a href="{{ route('users') }}">
                            <div class="col-3">
                                <div class="avatar-sm rounded-circle bg-info border-primary border shadow">
                                    <i class="fe-user font-22 avatar-title text-white"></i>
                                </div>
                            </div>
                            <div class="col-9">
                                <div class="text-end">
                                    <h3 class="text-dark mt-1"><span>{{ $total_users }}</span></h3>
                                    <p class="text-muted mb-1 text-truncate">{{__('messages.total') }} {{__('messages.users') }}</p>
                                </div>
                            </div>
                        </a>
                    </div> <!-- end row-->
            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row">
                        <a href="{{ route('users') }}">
                            <div class="col-3">
                                <div class="avatar-sm rounded-circle bg-success border-success border shadow">
                                    <i class="fe-user font-22 avatar-title text-white"></i>
                                </div>
                            </div>
                            <div class="col-9">
                                <div class="text-end">
                                    <h3 class="text-dark mt-1"><span data-plugin="counterup">{{ $total_admin }}</span></h3>
                                    <p class="text-muted mb-1 text-truncate">{{__('messages.total') }} {{__('messages.administrators') }}</p>
                                </div>
                            </div>
                        </a>    
                    </div> <!-- end row-->
            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row">
                        <a href="">
                            <div class="col-3">
                                <div class="avatar-sm rounded-circle bg-primary border-info border shadow">
                                    <i class="fe-user font-22 avatar-title text-white"></i>
                                </div>
                            </div>
                            <div class="col-9">
                                <div class="text-end">
                                    <h3 class="text-dark mt-1"><span data-plugin="counterup">{{ $total_customer }}</h3>
                                    <p class="text-muted mb-1 text-truncate">{{__('messages.total') }}  {{__('messages.customers') }} </p>
                                </div>
                            </div>
                        </a>
                    </div> <!-- end row-->
                ...
                <div class="card-body">
                    <div class="row">
                        <a href="{{ route('companies') }}">
                            <div class="col-3">
                                <div class="avatar-sm rounded-circle bg-warning border-warning border shadow">
                                    <i class="fe-user font-22 avatar-title text-white"></i>
                                </div>
                            </div>
                            <div class="col-9">
                                <div class="text-end">
                                    <h3 class="text-dark mt-1"><span data-plugin="counterup">{{ $total_companies }}</span></h3>
                                    <p class="text-muted mb-1 text-truncate">{{__('messages.total') }}  {{__('messages.companies') }} </p>
                                </div>
                            </div>
                        </a>
                    </div> <!-- end row-->
