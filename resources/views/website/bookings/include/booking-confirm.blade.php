...
<div class="container heading-background py-3 mb-3">
    <div class="container text-start fw-bold">{{ __('messages.payment_method') }}</div>
</div>
...
<form method="post" id="orderBookingFormSubmit" action="{{ route('booking.payment') }}" enctype="multipart/form-data">
    ...
    <div class="container heading-background py-3 mb-3">
        <div class="container text-start fw-bold">{{ __('messages.billing_address') }}</div>
    </div>
    <div class="container cvv-card py-3">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <label for="firstName" class="form-label fw-bold">{{ __('messages.first_name') }}</label>
                @if (auth()->check())
                    @php
            ...
            <div class="col-md-6">
                <label for="email" class="form-label fw-bold">{{ __('messages.email_address') }}</label>
                <div class="input-group">
            ...
            <div class="col-md-6">
                <label for="phone" class="form-label fw-bold">{{ __('messages.phone_number') }}</label>
                <div class="input-group">
            ...
            <div class="col-md-6">
                <label class="custom-label">{{ __('messages.postal_code') }}</label>
                <div class="input-group">
            ...
            <div class="col-md-6">
                <label class="custom-label">{{ __('messages.billing_address') }}</label>
                <div class="input-group">
            ...
            {{-- <div class="col-md-12">
                    @if (auth()->check())
                    <button type="submit" id="OrderSubmitBtn" class="btn-order-book btn-orange-clr mt-4"><i class="fa-solid fa-cart-shopping"></i> {{ __('messages.process_to_checkout') }} </button>
                    @else
                    <button data-bs-toggle="modal" data-bs-target="#loginModal" class="btn-order-book btn-orange-clr mt-4"><i class="fa-solid fa-cart-shopping"></i> {{ __('messages.process_to_checkout') }} </button>
                    @endif
                </div>             --}}
            <div class="col-md-12">
                ...
                @if (auth()->check())
                    <button type="submit" id="OrderSubmitBtn" class="btn-order-book btn-orange-clr mt-4" disabled>
                        <i class="fa-solid fa-cart-shopping"></i> {{ __('messages.process_to_checkout') }}
                    </button>
                @else
