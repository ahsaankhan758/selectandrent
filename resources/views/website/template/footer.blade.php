      ...
      <div class="container">
          <div class="row">
              ...
              <img src="{{asset('/')}}company-assets/logo/select-and-rent--jpg 2.png" alt="Logo" width="60px" height="60px">
                  <p>{{ __('messages.Whether you need a compact car for city drives, a luxury vehicle for a special event, or a spacious SUV for a family trip, our rental service offers a wide range of options tailored to your needs') }}.</p>
                  ...
                  <div class="buttons">
                      <a href="#" class="contact-btn-ctn">{{ __('messages.CONTACT US') }}</a>
