        ...
        <div class="container py-4 mt-5">
            ...
            <div class="container text-center my-3">
                <div class="d-flex flex-wrap justify-content-center gap-2">
                    ...
                    <button class="btn btn-dark filter-btn" data-category="Hatchback">Hatchback</button>
                    <button class="btn btn-dark filter-btn" data-category="Sedan">Sedan</button>
                    <button class="btn btn-dark filter-btn" data-category="Sport Cars">Sport Cars</button>
                </div>
            </div>
            ...
            <div class="container mt-5">
                <div class="row g-4">
                    <!-- SUV Cards -->
                    <div class="col-md-4 col-lg-3 car-card-item" data-category="SUV">
                        <div class="car-card">
                            <img src="{{asset('/')}}company-assets/assets/4.png" alt="SUV">
                            <div class="card-body">
                                <h6>SUV</h6>
                                <div class="d-flex align-items-center justify-content-between">
                                    <p class="vehicles mb-0">24 Vehicles</p>
                    ...
                    <!-- Hatchback Cards -->
                    <div class="col-md-4 col-lg-3 car-card-item" data-category="Hatchback">
                        <div class="car-card">
                            <img src="{{asset('/')}}company-assets/assets/3.png" alt="Hatchback">
                            <div class="card-body">
                                <h6>Hatchback</h6>
                                <div class="d-flex align-items-center justify-content-between">
                                    <p class="vehicles mb-0">24 Vehicles</p>
                    ...
                    <!-- Sedan Cards -->
                    <div class="col-md-4 col-lg-3 car-card-item" data-category="Sedan">
                        <div class="car-card">
                            <img src="{{asset('/')}}company-assets/assets/2.png" alt="Sedan">
                            <div class="card-body">
                                <h6>Sedan</h6>
                                <div class="d-flex align-items-center justify-content-between">
                                    <p class="vehicles mb-0">24 Vehicles</p>
                    ...
                    <!-- Sport Cars Cards -->
                    <div class="col-md-4 col-lg-3 car-card-item" data-category="Sport Cars">
                        <div class="car-card">
                            <img src="{{asset('/')}}company-assets/assets/1.png" alt="Sport Cars">
                            <div class="card-body">
                                <h6>Sport Cars</h6>
                                <div class="d-flex align-items-center justify-content-between">
                                    <p class="vehicles mb-0">24 Vehicles</p>
...
<div class="step-item reverse">
    <div class="icon-wrap"><img src="{{asset('/')}}company-assets/icons/work-handshake.png" alt="Step Icon"></div>
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-4">
            <div class="tip-card active text-center p-3">
                <div class="icon-container mb-2">
                    <img src="{{asset('/')}}company-assets/icons/tip-img-2.png" alt="Verify Features" class="img-fluid" >
                </div>
        ...
        <div class="col-md-4">
            <div class="tip-card text-center p-3">
                <div class="icon-container mb-2">
                    <img src="{{asset('/')}}company-assets/icons/tip-img-3.png" alt="Longer Rentals" class="img-fluid" >
                </div>
...
<!-- end accordian -->
      ...
      <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const cards = document.querySelectorAll(".car-card-item");
