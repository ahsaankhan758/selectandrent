...
@section('title')
{{ __('messages.Join') }}  | {{ __('messages.Select and Rent') }} 
@endsection
 ...
 <div class="container desktop-view my-5">
    ...
    <div class="row mt-3 align-items-center">
        ...
        <div class="col-lg-4 col-md-4 ps-lg-4 mb-3">
            <ul class="list-unstyled">
                <li><img src="{{asset('/')}}company-assets/icons/Security2.png" alt="security"> <strong>{{ __('messages.Best Choicing') }} </strong></li>
                <p class="text-muted ">{{ __('messages.Uniquely revolutionize manufactured products for interactive customer service') }} .</p>

                <li><img src="{{asset('/')}}company-assets/icons/Security2.png" alt="security"> <strong>{{ __('messages.Good People') }} </strong></li>
                <p class="text-muted ">{{ __('messages.Uniquely revolutionize manufactured products for interactive customer service') }} .</p>
            </ul>
            <button class="btn btn-orange-clr rounded-pill text-white">
                {{ __('messages.View All') }}   <img src="{{asset('/')}}company-assets/icons/Frame-1707482121.png" class="ms-2" width="20" height="20" alt="">
            </button> 
        </div>
    </div>
</div>
...
<div class="mobile-container">
    ...
    <div class="mobile-box">
        <p class="mobile-check"><img src="{{asset('/')}}company-assets/icons/Security2.png" alt="security">{{ __('messages.Best Choicing') }}  </p>
        <p class="mobile-text">{{ __('messages.Uniquely revolutionize manufactured products for interactive customer service') }} .</p>
    </div>

    <div class="mobile-box">
        <p class="mobile-check"><img src="{{asset('/')}}company-assets/icons/Security2.png" alt="security">{{ __('messages.Good People') }}  </p>
        <p class="mobile-text">{{ __('messages.Uniquely revolutionize manufactured products for interactive customer service') }} .</p>
    </div>
    ...
    <ul class="mobile-list">
        <li><img src="{{asset('/')}}company-assets/icons/Security2.png" alt="security">{{ __('messages.Passive Income') }}  </li>
        <li><img src="{{asset('/')}}company-assets/icons/Security2.png" alt="security">{{ __('messages.Reduced Costs') }}  </li>
        <li><img src="{{asset('/')}}company-assets/icons/Security2.png" alt="security">{{ __('messages.Peace of Mind') }}  </li>
        <li><img src="{{asset('/')}}company-assets/icons/Security2.png" alt="security">{{ __('messages.Flexibility') }}  </li>
    </ul>
...
<div class="benefits-container mobile-benefits">
 ...
 <div class="container py-5">
    <h2 class="text-center text-warning mb-4">{{ __('messages.How It Works') }}</h2>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="pricing-card p-4">
                ...
                <ul class="feature-list">
                    <li><img src="{{asset('/')}}company-assets/icons/security.png" alt="security"> 02 {{ __('messages.Passengers') }}</li>
                    <hr>
                    <li><img src="{{asset('/')}}company-assets/icons/security.png" alt="security"> 5 {{ __('messages.km Distance Only') }}</li>
                    <hr>
                    <li><img src="{{asset('/')}}company-assets/icons/security.png" alt="security"> {{ __('messages.No Extra Charges') }}</li>
                    <hr>
                    <li><img src="{{asset('/')}}company-assets/icons/security.png" alt="security"> {{ __('messages.Free Book NO Advance') }}</li>
                </ul>
