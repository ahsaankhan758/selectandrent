...
$(document).ready(function () {
    ...
    // All filter fields trigger immediate reload
    $('#options-dropdown, #startDate, #endDate, #country-dropdown').on('change', function () {
        fetchAndRenderChart();
    });

    // Period dropdown (week/month/year/custom range)
    $('.filter-option').on('click', function (e) {
        ...
        // Reload chart with selected filter
...
//     function fetchAndRenderChart(filter = 'week') {
//         const userId = getSelectedCompanyId();
//         const startDate = $('#startDate').val();
//         const endDate = $('#endDate').val();

//         const useDefault = !userId && !startDate && !endDate;

//         const ajaxParams = useDefault
//             ? { filter: filter }
//             : {
//                 filter: filter,
//                 user_id: userId || null,
